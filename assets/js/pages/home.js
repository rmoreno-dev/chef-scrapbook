      ...
      '<div class="view view--home">',
        ...
        '<section class="home-hero" aria-label="Bienvenida">',
          '<div class="home-hero__content">',
            ...
            '<div class="home-hero__actions">',
              '<a class="btn btn--primary" href="#/recetas">',
                '<img src="assets/icons/recipe.svg" alt="" width="16" height="16">',
                'Ver recetas',
              '</a>',
          ...
          '<div class="home-hero__deco" aria-hidden="true">',
            '<img src="assets/branding/brand-stamp.svg" alt="" width="140" height="140" class="home-hero__stamp">',
          '</div>',
        '</section>',
        ...
        '<section class="home-section" aria-labelledby="heading-novedades">',
          '<header class="home-section__header">',
            '<h2 class="home-section__title" id="heading-novedades">',
              '<img src="assets/icons/sparkle.svg" alt="" width="18" height="18" class="section-icon">',
              'Novedades',
            '</h2>',
          '</header>',
          '<div class="news-grid">',
            '<div class="news-card">',
              '<div class="news-card__icon-wrap"><img src="assets/icons/scale.svg" alt="" width="28" height="28"></div>',
            ...
            '</div>',
            '<div class="news-card">',
              '<div class="news-card__icon-wrap"><img src="assets/icons/calendar.svg" alt="" width="28" height="28"></div>',
        ...
        '<section class="home-section" aria-labelledby="heading-ultimas">',
          '<header class="home-section__header">',
            '<h2 class="home-section__title" id="heading-ultimas">',
              '<img src="assets/icons/recipe.svg" alt="" width="18" height="18" class="section-icon">',
              'Últimas Recetas',
            '</h2>',
          ...
          '<div class="recipe-row">',
            ...
            '<div class="coming-soon-slot">',
              '<img src="assets/icons/leaf.svg" alt="" width="32" height="32">',
              '<p>Próximamente</p>',
            '</div>',
            '<div class="coming-soon-slot">',
              '<img src="assets/icons/leaf.svg" alt="" width="32" height="32">',
        ...
        '<section class="home-section" aria-labelledby="heading-menus-dest">',
          '<header class="home-section__header">',
            '<h2 class="home-section__title" id="heading-menus-dest">',
              '<img src="assets/icons/calendar.svg" alt="" width="18" height="18" class="section-icon">',
              'Menús Destacados',
            '</h2>',
          ...
          '<div class="menu-highlight-row">',
            '<a class="menu-highlight-card" href="#/menus">',
              '<img src="assets/icons/calendar.svg" alt="" width="36" height="36">',
            ...
            '<div class="menu-highlight-card menu-highlight-card--soon">',
              '<img src="assets/icons/journal.svg" alt="" width="36" height="36">',
        ...
        /* ── NOTA DE PAPEL ── */
        '<aside class="home-note paper-scrap paper-scrap--rotate-neg" aria-label="Nota">',
