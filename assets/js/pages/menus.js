    ...
    container.innerHTML = [
      '<div class="view view--menus">',
        ...
        '<div class="menus-bottom-grid">',
          ...
          '<section class="paper-scrap" aria-labelledby="heading-prep">',
            ...
            '<form class="task-add-form" id="prep-task-form" aria-label="Agregar tarea">',
              ...
              '<button type="submit" class="task-add-form__btn btn btn--ghost btn--sm">',
                '<img src="assets/icons/plus.svg" alt="" width="14" height="14">',
                'Agregar',
              '</button>',
            '</form>',
          '</section>',

          '<section class="paper-scrap paper-scrap--rotate-neg" aria-labelledby="heading-shopping">',
            ...
            '<div class="shopping-header">',
              '<h2 class="section-heading" id="heading-shopping">',
                '<img src="assets/icons/ingredients.svg" alt="" width="18" height="18">',
                'Lista de Compras',
              '</h2>',
